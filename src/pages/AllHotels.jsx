...
function AllHotels() {
    ...
    return (
        <div className="flex  py-50  md:flex-row h-screen gap-4">
            {/* section 1 */}
                                ...
                                <div className=" flex flex-col gap-2 w-full">
                                    ...
                                    <div className="mt-2.5 grid grid-cols-2 md:flex md:flex-wrap gap-2">
                                        {roomData.amenities.map((amenitie, index) => (
                                            <small key={index} className='p-2 rounded-lg bg-gray-200 mr-2 '>{amenitie}</small>
                                        ))}
                                    </div>
            ...
            {/* section 2  */}
            <div className="md:w-1/3 w-full bg-blue-700 ">test2</div>
        </div>
    )
}
